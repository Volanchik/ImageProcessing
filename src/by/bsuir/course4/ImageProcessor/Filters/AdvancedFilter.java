		...
		try {
			...
			for (int i = 0; i < height; ++i){
				for (int j = 0; j < width; ++j) {	
					...
					aggregationBlue = (int)(getBlueComponent(pixel)*brightness);
					aggregationGreen = (int)(getGreenComponent(pixel)*brightness);
					aggregationRed = (int)(getRedComponent(pixel)*brightness);
					
					aggregationBlue = aggregationBlue>=255 ? 255 : aggregationBlue;
					aggregationGreen = aggregationGreen>=255 ? 255 : aggregationGreen;
					aggregationRed = aggregationRed>=255 ? 255 : aggregationRed;
					
					pixel = composePixel(aggregationBlue,aggregationGreen,aggregationRed);
			...
			File resultFile = new File(ROOT_PATH + "\\" + "AdvancedFilter.png");
